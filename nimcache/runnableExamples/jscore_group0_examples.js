...
var NTI520093730 = {size: 0,kind: 31,base: null,node: null,finalizer: null};
var NTI520093739 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
var NNI520093739 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "a", len: 0, typ: NTI520093730, name: "a", sons: null}, 
...
framePtr = F;
framePtr = F.prev;
var F = {procname: "module jscore_examples1", prev: framePtr, filename: "/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim", line: 0};
framePtr = F;
framePtr = F.prev;
...
function HEX2EHEX2E_520093730(a_520093733, b_520093734) {
  ...
  framePtr = F;
    F.line = 507;
    result_520093737 = nimCopy(result_520093737, {a: a_520093733, b: b_520093734}, NTI520093739);
  framePtr = F.prev;
...
function auxWriteStackTrace_33556541(f_33556542) {
  ...
  var result_33556543 = [[]];
    ...
    Label6: do {
      var j_33556600 = 0;
      var colontmp__520093958 = 0;
      colontmp__520093958 = (i_33556552 - 1);
      var res_520093960 = colontmp__520093958;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_520093960)) break Label8;
            j_33556600 = res_520093960;
...
function HEX3DHEX3D_520093708(x_520093710, y_520093711) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      var i_520093766 = 0;
      F.line = 126;
      var colontmp__520093946 = ({a: 0, b: 0});
      F.line = 308;
      colontmp__520093946 = nimCopy(colontmp__520093946, HEX2EHEX2E_520093730(0, subInt((x_520093710).length, 1)), NTI520093739);
      Label2: do {
        F.line = 129;
        var x_520093952 = 0;
        F.line = 90;
        var res_520093953 = colontmp__520093946.a;
        Label3: do {
          F.line = 91;
            Label4: while (true) {
            if (!(res_520093953 <= colontmp__520093946.b)) break Label4;
              F.line = 129;
              x_520093952 = res_520093953;
              F.line = 308;
              i_520093766 = x_520093952;
              ...
              F.line = 93;
              res_520093953 = addInt(res_520093953, 1);
            }
        } while (false);
      } while (false);
    } while (false);
...
function HEX3DHEX3D_520093798(x_520093800, y_520093801) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      F.line = 308;
      colontmp__520093965 = nimCopy(colontmp__520093965, HEX2EHEX2E_520093730(0, subInt((x_520093800).length, 1)), NTI520093739);
      Label2: do {
        F.line = 129;
        var x_520093967 = 0;
        F.line = 90;
        ...
        Label3: do {
          F.line = 91;
            ...
            if (!(res_520093968 <= colontmp__520093965.b)) break Label4;
              ...
              if (!((x_520093800[chckIndx(i_520093828, 0, (x_520093800).length - 1)] == y_520093801[chckIndx(i_520093828, 0, (y_520093801).length - 1)]))) {
              F.line = 310;
              result_520093802 = false;
              break BeforeRet;
              }
...
var F = {procname: "module jscore_examples1", prev: framePtr, filename: "/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim", line: 0};
framePtr = F;
if (!(HEX3DHEX3D_520093708([97, 98, 99, 100, 101].copyWithin(0, 3, 4), [100, 98, 99, 100, 101]))) {
F.line = 7;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(7, 8) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(0, 3, 4) == @[\'d\', \'b\', \'c\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D_520093708([97, 98, 99, 100, 101].copyWithin(1, 3), [97, 100, 101, 100, 101]))) {
F.line = 8;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(8, 8) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(1, 3) == @[\'a\', \'d\', \'e\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D_520093798(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2), [1, 2, 3, 1, 2]))) {
F.line = 9;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(9, 8) `[1, 2, 3, 4, 5].copyWithin(-2) == @[1, 2, 3, 1, 2]` "));
}

if (!(HEX3DHEX3D_520093798(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3), [4, 5, 3, 4, 5]))) {
F.line = 10;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(10, 8) `[1, 2, 3, 4, 5].copyWithin(0, 3) == @[4, 5, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D_520093798(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3, 4), [4, 2, 3, 4, 5]))) {
F.line = 11;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(11, 8) `[1, 2, 3, 4, 5].copyWithin(0, 3, 4) == @[4, 2, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D_520093798(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2, -3, -1), [1, 2, 3, 3, 4]))) {
F.line = 12;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim(12, 8) `[1, 2, 3, 4, 5].copyWithin(-2, -3, -1) == @[1, 2, 3, 3, 4]` "));
}
