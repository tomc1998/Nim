...
function auxWriteStackTrace_33556541(f_33556542) {
  ...
  var result_33556543 = [[]];
    ...
    Label6: do {
      var j_33556600 = 0;
      var colontmp__520093730 = 0;
      colontmp__520093730 = (i_33556552 - 1);
      var res_520093732 = colontmp__520093730;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_520093732)) break Label8;
            j_33556600 = res_520093732;
...
framePtr = F;
F.line = 7;
var data_520093697 = new FormData();
F.line = 8;
data_520093697.set("key0", "value0");
F.line = 9;
data_520093697.append("key1", "value1");
F.line = 10;
data_520093697.delete("key1");
if (!(data_520093697.has("key0"))) {
F.line = 11;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples1.nim(11, 8) `data.hasKey(\"key0\")` "));
}

if (!((data_520093697.get("key0") == "value0"))) {
F.line = 12;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples1.nim(12, 8) `data[\"key0\"] == \"value0\".cstring` "));
}

F.line = 13;
(() => { const frmdt = data_520093697; Array.from(frmdt.keys()).forEach((key) => frmdt.delete(key)) })();
if (!((Array.from(data_520093697.entries()).length == 0))) {
F.line = 14;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples1.nim(14, 8) `data.len == 0` "));
}
