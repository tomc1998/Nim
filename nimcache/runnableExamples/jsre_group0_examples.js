...
var NTI587202586 = {size: 0,kind: 31,base: null,node: null,finalizer: null};
var NTI587202595 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NNI587202595 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "a", len: 0, typ: NTI587202586, name: "a", sons: null}, 
{kind: 1, offset: "b", len: 0, typ: NTI33554456, name: "b", sons: null}]};
NTI587202595.node = NNI587202595;
...
function auxWriteStackTrace_33556541(f_33556542) {
  ...
  var result_33556543 = [[]];
    ...
    Label6: do {
      var j_33556600 = 0;
      var colontmp__520093716 = 0;
      colontmp__520093716 = (i_33556552 - 1);
      var res_520093718 = colontmp__520093716;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_520093718)) break Label8;
            j_33556600 = res_520093718;
...
framePtr = F;
F.line = 7;
var jsregex_520093697 = new RegExp("bc$", "i");
if (!(contains_536870961("abc", jsregex_520093697))) {
F.line = 8;
...
if (!(!(contains_536870961("abcd", jsregex_520093697)))) {
F.line = 9;
...
if (!(contains_536870961("xabc", jsregex_520093697))) {
F.line = 10;
...
framePtr = F;
F.line = 7;
var jsregex_553648129 = new RegExp("abc", "i");
if (!(startsWith_536870965("abcd", jsregex_553648129))) {
F.line = 8;
...
framePtr = F;
F.line = 7;
var jsregex_570425345 = new RegExp("bcd", "i");
if (!(endsWith_536870978("abcd", jsregex_570425345))) {
F.line = 8;
...
function HEX2EHEX2E_587202593(a_587202596, b_587202597) {
  var result_587202600 = ({a: 0, b: 0});

  var F = {procname: ".....", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/system.nim", line: 0};
  framePtr = F;
    F.line = 507;
    result_587202600 = nimCopy(result_587202600, {a: a_587202596, b: b_587202597}, NTI587202595);
  framePtr = F.prev;

  return result_587202600;
...
function HEX3DHEX3D_587202571(x_587202573, y_587202574) {
  var result_587202575 = false;

  var F = {procname: "==.==", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/system/comparisons.nim", line: 0};
  framePtr = F;
  BeforeRet: do {
    F.line = 301;
    var sameObject_587202583 = false;
    F.line = 302;
    sameObject_587202583 = x_587202573 === y_587202574
    if (sameObject_587202583) {
    F.line = 303;
    result_587202575 = true;
    break BeforeRet;
    }
    
    if (!(((x_587202573).length == (y_587202574).length))) {
    F.line = 306;
    result_587202575 = false;
    break BeforeRet;
    }
    ...
    Label1: do {
      ...
      var i_587202629 = 0;
      F.line = 126;
      var colontmp__587202697 = ({a: 0, b: 0});
      F.line = 308;
      colontmp__587202697 = nimCopy(colontmp__587202697, HEX2EHEX2E_587202593(0, subInt((x_587202573).length, 1)), NTI587202595);
      Label2: do {
        F.line = 129;
        var x_587202703 = 0;
        F.line = 90;
        var res_587202704 = colontmp__587202697.a;
        Label3: do {
          F.line = 91;
            Label4: while (true) {
            if (!(res_587202704 <= colontmp__587202697.b)) break Label4;
              F.line = 129;
              x_587202703 = res_587202704;
              F.line = 308;
              i_587202629 = x_587202703;
              if (!((x_587202573[chckIndx(i_587202629, 0, (x_587202573).length - 1)] == y_587202574[chckIndx(i_587202629, 0, (y_587202574).length - 1)]))) {
              F.line = 310;
              result_587202575 = false;
              break BeforeRet;
              }
              ...
              F.line = 93;
              res_587202704 = addInt(res_587202704, 1);
            }
        } while (false);
      } while (false);
    } while (false);
...
framePtr = F;
F.line = 7;
var jsregex_587202561 = new RegExp("\\s+", "i");
F.line = 8;
jsregex_587202561.compile("\\w+", "i");
if (!(contains_536870961("nim javascript", jsregex_587202561))) {
F.line = 9;
...
if (!(HEX3DHEX3D_587202571(jsregex_587202561.exec("nim javascript"), ["nim"]))) {
F.line = 10;
...
if (!((jsregex_587202561.toString() == "/\\w+/i"))) {
F.line = 11;
...
F.line = 12;
jsregex_587202561.compile("[0-9]", "i");
if (!(contains_536870961("0123456789abcd", jsregex_587202561))) {
F.line = 13;
...
if (!(eqStrings(HEX24_536870953(jsregex_587202561), makeNimstrLit("/[0-9]/i")))) {
F.line = 14;
...
F.line = 15;
jsregex_587202561.compile("abc", "i");
if (!(startsWith_536870965("abcd", jsregex_587202561))) {
F.line = 16;
...
if (!(endsWith_536870978("dabc", jsregex_587202561))) {
F.line = 17;
...
F.line = 18;
jsregex_587202561.compile("\\d", "i");
if (!(HEX3DHEX3D_587202571("do1ne".split(jsregex_587202561), ["do", "ne"]))) {
F.line = 19;
...
F.line = 20;
jsregex_587202561.compile("[lw]", "i");
if (!(("hello world".replace(jsregex_587202561, "X") == "heXlo world"))) {
F.line = 21;
